                ...
                <div class="col-sm-12">
                  ...
                  <div class="collection-product-wrapper">
                    ...
                    <div class="product-wrapper-grid">
                      <div class="row">
                        <div v-for="(item, index) in products" :key="index" class="col-grid-box col-lg-3">
